...
const PLANS = [
  ...
  },
  {
    ...
    points: ["Up to 6 pages", "Google Analytics call/WhatsApp/form events", "On-page SEO + OG images"],
    badge: "Most Popular",
    minPrice: 3000,
  },
  {
    ...
    points: ["Unlimited pages", "Performance + accessibility pass", "Integrations (Calendly, Google Analytics, more)"],
    ...
    <main id="content" className="mx-auto max-w-6xl px-4 py-16">
      ...
      <section className="mt-12 max-w-2xl text-sm text-slate-600">
        ...
        <ul className="mt-3 list-disc pl-5">
          ...
          <li>Integrations (Calendly, Google Analytics, forms, maps, basic CMS)</li>
