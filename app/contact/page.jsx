...
export default function ContactPage() {
  return (
    <section className="mx-auto max-w-2xl px-4 py-16">
     ...
     <form action="https://formspree.io/f/yourFormId" method="POST" className="mt-6 grid gap-4">
...
<p className="text-xs text-gray-500 mt-2">You’ll get a confirmation after submission.</p>
